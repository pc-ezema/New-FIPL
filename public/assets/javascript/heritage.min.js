document.onreadystatechange = function () {
    document.addEventListener('DOMContentLoaded', function () { 
        setTimeout(function () {
            var temp = document.getElementsByClassName("sideTab")[0].offsetWidth + "px";
            document.getElementsByClassName("heritageYearRange")[0].style.width = document.getElementsByClassName("sideTab")[0].clientWidth + "px";
            if (window.innerWidth > 991) {
                document.getElementsByClassName("sideTab")[0].style.width = temp;
                var leftArrowPosition = document.getElementsByClassName("forLineBg")[0].getBoundingClientRect().left + document.getElementsByClassName("forLineBg")[0].offsetWidth / 2 - document.getElementsByClassName("after")[0].offsetWidth / 2 - 15 + "px";
                document.getElementsByClassName("after")[0].style.left = leftArrowPosition;
                document.getElementsByClassName("before")[0].style.left = leftArrowPosition;
            } else {
                document.getElementsByClassName("sideTab")[0].style.width = parseInt(temp) + 10 + "px";
                var leftArrowPosition = document.getElementsByClassName("forLineBg")[0].getBoundingClientRect().left + document.getElementsByClassName("forLineBg")[0].offsetWidth / 2 - 15 + "px";
                document.getElementsByClassName("after")[0].style.left = leftArrowPosition;
                document.getElementsByClassName("before")[0].style.left = leftArrowPosition;
            }
            if(window.innerWidth > 575 && window.innerWidth < 991){
                if(document.getElementsByClassName("sideTab")[0].children.length < 20){
...
var heroHeritageItem = document.querySelectorAll(".innerCarousel > .carItem");
var src, posterImage, videoDivs;

for (var i = 0; i < heroHeritageItem.length; i++) {
    if (heroHeritageItem[i].children[1].classList.contains("videoContainerdiv")) {
        if (heroHeritageItem[i].classList.contains("active")) {
            autoTrue = true;
        } else {
            autoTrue = false;
        }
        heroHeritageItem[i].children[1].id = "divVideo" + i;
        var videoDiv = heroHeritageItem[i].children[1].dataset;
        src = videoDiv.href;
        posterImage = videoDiv.image;
        var playerInstance = jwplayer(heroHeritageItem[i].children[1].id);
...
var myHeritageBanner = document.getElementsByClassName("heritageBanner");
if (myHeritageBanner.length != 0) {
    for (var i = 0; i < myHeritageBanner.length; i++) {
        myHeritageBanner[i].setAttribute("showItem", "" + i);
        myHeritageBanner[i].children[0].classList.add("heroCarouselStory" + i);
        if (i == 0) {
            myHeritageBanner[i].classList.add("heritageYearActive");
            //myHeritageBanner[i].getElementsByClassName("sectionContent")[0].classList.remove("zeroOpacity");
        } else {
            myHeritageBanner[i].classList.add("mainSliderElem");
        }
    }
}
...
var beforeElem = document.getElementsByClassName("before")[0];
var afterElem = document.getElementsByClassName("after")[0];

beforeElem.addEventListener("click", scrollUpFn);
afterElem.addEventListener("click", scrollDownFn);

function scrollUpFn() {
    if (!beforeElem.classList.contains("noDisplay")) {
        for (var i = 0; i < 330; i++) {
            setTimeout(function () {
                sideTab[0].parentNode.scrollBy(0, -1);
            }, 2 * i)
        }
    }
}
...
function scrollDownFn() {
    if (!afterElem.classList.contains("noDisplay")) {
        for (var i = 0; i < 330; i++) {
            setTimeout(function () {
                sideTab[0].parentNode.scrollBy(0, 1);
            }, 2 * i)
    ...
    if (fb || twitter || linkedin || hangout || mailto) {
        if (fb[i]) {
            ...
            function chngImgColorfb() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/color/FB.svg)";
            }
            fb[i].addEventListener("mouseleave", chngImgfb);

            function chngImgfb() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/FB.svg)";
            }
        }
        if (twitter[i]) {
            ...
            function chngImgColortwitter() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/color/x-icon.svg)";
            }
            twitter[i].addEventListener("mouseleave", chngImgtwitter);

            function chngImgtwitter() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/x-icon.svg)";
            }
        }
        if (linkedin[i]) {
            ...
            function chngImgColorlinkedin() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/color/LinkedIn.svg)";
            }
            linkedin[i].addEventListener("mouseleave", chngImglinkedin);

            function chngImglinkedin() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/Linkedin.svg)";
            }
        }
        // if (hangout[i]) {
        ...
        //         this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/color/G+Yellow.svg)";
        //     }
        //     hangout[i].addEventListener("mouseleave", chngImghangout);

        //     function chngImghangout() {
        //         this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/G+white.svg)";
        //     }
        // }
        if (mailto[i]) {
            ...
            function chngImgColormailto() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/color/Contact_Us.svg)";
            }
            mailto[i].addEventListener("mouseleave", chngImgmailto);

            function chngImgmailto() {
                this.style.backgroundImage = "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/pages/heritage/shareOptions/Contact_Us.svg)";
            }
        }
...
var totalTime = 15000;
var heritageBanner = document.getElementsByClassName("heritageBanner");
var counter = 0;
var sideTabDiv = document.querySelectorAll(".sideTab");
var sideTab = document.querySelectorAll(".sideTab > li");
var count = 1;
var getAttr = 0;
var manualScroll = true

document.querySelectorAll(".heritageYearActive")[0].getElementsByClassName("carItem active")[0].getElementsByClassName("sectionContent")[0].classList.add("heritageYearHeadingAnimation");
setTimeout(function () {
    document.querySelectorAll(".heritageYearActive")[0].getElementsByClassName("carItem active")[0].getElementsByClassName("sectionContent")[0].classList.remove("zeroOpacity");
    document.querySelectorAll(".heritageYearActive")[0].getElementsByClassName("carItem active")[0].getElementsByClassName("sectionContent")[0].classList.remove("heritageYearHeadingAnimation");
}, 2000)
...
for (var i = 0; i < sectionContent.length; i++) {
    if (window.innerWidth > 992) {
        sectionContent[i].addEventListener("mouseover", mouseOverAni);
        sectionContent[i].addEventListener("mouseout", mouseOutAni)
    }

}

function mouseOverAni() {
    this.classList.add("contentActive");
    overlay = this.parentElement.parentElement.parentElement.children;
    if (overlay[1].classList.contains("imageOverlayHp")) {
        overlay[1].style.display = "block";
    }

}

function mouseOutAni() {
    this.classList.remove("contentActive");
    overlay = this.parentElement.parentElement.parentElement.children;
    if (overlay[1].classList.contains("imageOverlayHp")) {
...
document.addEventListener('DOMContentLoaded', function () {
    if (heritageBanner.length != 0) {
        for (var j = 0; j < heritageBanner.length; j++) {
            var heroCarouselStory = "heroCarouselStory" + j;
            for (var i = 0; i < document.getElementsByClassName(heroCarouselStory).length; i++) {
                sliderObj[sliderObj.length] = new CarousalComp(document.getElementsByClassName(heroCarouselStory)[i], totalTime);
                document.getElementsByClassName(heroCarouselStory)[i].addEventListener("touchstart", function (e) {
                    touchDirY = e.touches[0].clientY;
                    touchDirX = e.touches[0].clientX;
                });
                document.getElementsByClassName(heroCarouselStory)[i].addEventListener("touchend", function (e) {
                    if (Math.abs(e.changedTouches[0].clientY - touchDirY) < Math.abs(e.changedTouches[0].clientX - touchDirX)) {
                        var self = sliderObj[getAttr];
                        var itemActived = self.el.children[0].getElementsByClassName("carItem");
                        if (e.changedTouches[0].clientX < touchDirX) {

                            if (itemActived[itemActived.length - 1].classList.contains("active")) {
                                if (getAttr != sideTab.length - 1) {
                                    var nextIndex = document.querySelector(".sideTab > .active").nextElementSibling.nextElementSibling;
                                    heritageYearRange(nextIndex);
                                }
                            } else {
                                swipeScroll(self, e.changedTouches[0], document.querySelectorAll(".carItem.active")[0], touchDirX);
                            }

                        } else if (getAttr != 0 || !document.getElementsByClassName("carItem")[0].classList.contains("active")) {
                            if (itemActived[0].classList.contains("active")) {
                                var nextIndex = document.querySelector(".sideTab > .active").previousElementSibling.previousElementSibling;
                                heritageYearRange(nextIndex);
                            } else {
                                swipeScroll(self, e.changedTouches[0], document.querySelectorAll(".carItem.active")[0], touchDirX);
                            }
    ...
    sideTabDiv[0].addEventListener("scroll", function () {
        if (sideTabDiv[0].scrollTop == 0) {
            after.classList.remove("noDisplay");
            before.classList.add("noDisplay")
        } else if (sideTabDiv[0].offsetHeight + sideTabDiv[0].scrollTop >= sideTabDiv[0].scrollHeight) {
            before.classList.remove("noDisplay");
            after.classList.add("noDisplay")
        } else {
            before.classList.remove("noDisplay");
            after.classList.remove("noDisplay")
        }
...
//event on year on sideTab
for (var i = 0; i < sideTab.length; i++) {
    sideTab[i].addEventListener("click", function (e) {
        if (e.currentTarget) {
            heritageYearRange(e);
        }
    });
...
//animateYearRange
function animatedScroll(i, count) {
    setTimeout(function () {
        sideTab[0].parentNode.scrollBy(0, count);
    }, 3 * i);
}

var activeYear = 0;
// sideScroller year range
function heritageYearRange(e) {
    if (e.currentTarget) {
        var tempAttr = e.currentTarget.getAttribute("setItem");
    } else {
        var tempAttr = e.getAttribute("setItem");
    }
    if (activeYear != tempAttr) {
        if (heritageBanner[tempAttr].querySelectorAll(".carItem.active > .jwplayer").length != 0)
            jwplayer(heritageBanner[tempAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).stop();

        if (document.getElementsByClassName("centerIndicator")[0].classList.contains("activePause") && jwplayer(heritageBanner[tempAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() === "playing") {
            jwplayer(heritageBanner[tempAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).pause();
        }
        heritageBanner[getAttr].querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.add("zeroOpacity");


        var divIndicators = document.querySelectorAll(".heritageYearActive .carouselDiv .innerCarousel .Indicators .carouselIndicators div");
        for (var i = 0; i < divIndicators.length; i++) {
            divIndicators[i].children[0].style.width = 0 + "%";
        }

        if (e.currentTarget) {
            getAttr = e.currentTarget.getAttribute("setItem");
        } else {
            getAttr = e.getAttribute("setItem");
        }
        activeYear = getAttr;
        heritageBanner[getAttr].children[0].children[0].getElementsByClassName("active")[0].classList.remove("active");
        heritageBanner[getAttr].children[0].children[0].children[0].classList.add("active");
        var carouselIndicators = heritageBanner[getAttr].getElementsByClassName("carouselIndicators")
        for (var i = 0; i < carouselIndicators.length; i++) {
            carouselIndicators[0].children[i].children[0].style.width = "0%";
        }
        carouselIndicators[0].children[0].classList.add("active");
        stopSlide(findSlidingElem(heritageBanner[getAttr].getElementsByClassName("carouselDiv")));
        startSlide(findSlidingElem(heritageBanner[getAttr].getElementsByClassName("carouselDiv")));
        initSlide(findSlidingElem(heritageBanner[getAttr].getElementsByClassName("carouselDiv")));
        counter = 0;
        var currentTrg;
        if (e.currentTarget) {
            currentTrg = e.currentTarget.getBoundingClientRect().top;
        } else {
            currentTrg = e.getBoundingClientRect().top;
        }
        if (currentTrg > 0 && currentTrg < window.innerHeight) {
            if (currentTrg > window.innerHeight * 52 / 100) {
                for (var i = count; currentTrg > (window.innerHeight * 52 / 100); currentTrg -= 1) {
                    animatedScroll(i, count);
                    i++;
                }
            } else {
                for (var i = count; currentTrg < (window.innerHeight * 52 / 100); currentTrg += 1) {
        ...
        for (var i = 0; i < sideTab.length; i++) {
            sideTab[i].classList.remove("active");
            var sectionAttr = heritageBanner[getAttr].getAttribute("showItem")
            if (getAttr === sectionAttr) {
                if (heritageBanner[i].classList.contains("heritageYearActive")) {
                    heritageBanner[i].classList.remove("heritageYearActive");
                }
            }
        }

        heritageBanner[sectionAttr].classList.add("heritageYearActive");
        if (e.currentTarget) {
...
//code for indicators fill animations
setInterval(function () {
    var activeSlide = document.querySelectorAll(".carouselIndicators .active li");
    var divIndicators = document.querySelectorAll(".heritageYearActive .carouselDiv .innerCarousel .Indicators .carouselIndicators div");
    var pauseIcon = document.getElementsByClassName("centerIndicator")[0];
    if (window.innerWidth > 991) {
        if (!pauseIcon.classList.contains("activePause")) {
            if ((heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer").length === 0) || (jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() === "playing") || (jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() === "complete") ) {
                counter += 10000 / totalTime;
            }
        }
    } else {
        if (!pauseIcon.classList.contains("activePause")) {
    ...
    var indicatorWidth = divIndicators[0].parentElement.lastElementChild.children[0].style.width;
    if (parseInt(indicatorWidth) > 98) {
        counter = 0;
        activeSlide[getAttr].style.width = 0 + "%";
        if (getAttr != sideTab.length - 1) {
            var nextIndex = document.querySelector(".sideTab > .active").nextElementSibling.nextElementSibling;
            heritageYearRange(nextIndex);
        }
        ...
        activeSlide[getAttr].style.width = counter + "%"
    }
...
// img description starts
var abtUsTooltip = document.querySelectorAll(".abtUsTooltip");
var toolTipFlag = false;


for (var i = 0; i < abtUsTooltip.length; i++) {
    abtUsTooltip[i].addEventListener("click", function () {
        this.children[1].children[1].classList.toggle("dispNone");
        if (!this.children[1].children[1].classList.contains("dispNone"))
            toolTipFlag = true;
    })
}

if (window.innerWidth > 575) {
    var showTooltip = document.getElementsByClassName("imgDescText dispNone");
...
if (window.innerWidth < 575) {
    ...
    for (var i = 0; i < readMore.length; i++) {
        readMore[i].classList.remove("dispNone");
    }
    var section = document.getElementsByTagName("section");
    if (section) {
        for (var i = 0; i < section.length; i++) {
            section[i].classList.add("clickableDiv");
        }
    }
}
...
function closeToolTip() {
    var temp = document.getElementsByClassName("imgDescText");
    if (!toolTipFlag) {
        for (var i = 0; i < temp.length; i++) {
            temp[i].classList.add("dispNone");
        }
    }
    toolTipFlag = false;
}
// img description ends
...
function popupVideoPlayPause() {
    if (window.innerWidth > 320 && screen.width > 320) {
        ...
        if (!el.classList.contains("activePause") || !activePause) {
            ...
            for (i = 0; i < heritageBanner[getAttr].querySelectorAll(".carItem").length; i++) {

                if (heritageBanner[getAttr].querySelectorAll(".carItem")[i].classList.contains("active")) {
                    if (el.classList.contains("activePause")) {
                        if (heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer").length != 0)
                            jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).pause();
                        stopSlide(findSlidingElem(heritageBanner[getAttr].children));
                    } else {
                        if (heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer").length != 0) {
                            jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).play();
                            vidCT = jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0].id).getPosition();
                            vidMD = jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0].id).getDuration();
                            carouselTimeUp = Math.floor(vidMD - vidCT);
                            if (parseInt(carouselTimeUp) == 0)
                                carouselTimeUp = parseInt(totalTime);
                            else {
                                carouselTimeUp = parseInt((carouselTimeUp) * 1000);
                            }
                            self.intervalCarousel = carouselTimeUp;
                        } else {
                            vidCT = heritageBanner[getAttr].querySelectorAll(".carouselIndicators > div.active > li")[0].style.width;
                            vidMD = 100;
                            carouselTimeUp = parseInt(totalTime - ((parseInt(vidCT)) / vidMD) * totalTime);
                            self.intervalCarousel = carouselTimeUp;
                        }
            ...
            if (!el.classList.contains("activePause")) {
                testFlag = true;
                startSlide(findSlidingElem(heritageBanner[getAttr].children));
            }
        ...
        if (window.innerWidth > 320 && screen.width > 320) {
            ...
            for (i = 0; i < heritageBanner[getAttr].querySelectorAll(".carItem").length; i++) {
                ...
                if (heritageBanner[getAttr].querySelectorAll(".carItem")[i].classList.contains("active")) {
                    if (el.classList.contains("activePause")) {
                        if (heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer").length != 0)
                            if (jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() !== "paused") {
                                if(jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() === "complete"){
									jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).stop();
                                }else{
                                jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).pause();
                            }
                        ...
                        manualScroll = true;
                        if (heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer").length != 0) {
                            if (jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() !== "playing" || jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() !== "buffering") {
                                jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).play();
                            }
                            vidCT = jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0].id).getPosition();
                            vidMD = jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0].id).getDuration();
...
CarousalComp.prototype = {
    ...
    init: function (self) {
        ...
        self.startImgTimer(self);
        self.indicators = self.el.querySelectorAll(".carouselIndicators div");
    ...
    changeImageCar: function (dirParam, self, flagChild, elemCur) {
        ...
        if (!dirParam) {
            ...
            if (self.el.getElementsByClassName("carItem")[self.el.getElementsByClassName("carItem").length - 1].classList.contains("active") &&
                self.el.getElementsByClassName("active")[0] == heritageBanner[getAttr].children[0].getElementsByClassName("active")[0]
            ) {
                var nextIndex = document.querySelector(".sideTab > .active").nextElementSibling.nextElementSibling;
                if(nextIndex){
                heritageYearRange(nextIndex);
            }else{
                heritageYearRange(document.querySelector(".sideTab > .active"));
            }
    ...
    slideImage: function (elemList, currentIndex, nextIndex, dirClass1, dirClass2, self) {
        ...
        if (self.el.getElementsByClassName("active")[0] == heritageBanner[getAttr].children[0].getElementsByClassName("active")[0]) {
            self.intervalCarousel = totalTime;
            if (!self.el.getElementsByClassName("carItem")[self.el.getElementsByClassName("carItem").length - 1].classList.contains("active")) {
                counter = 0;
            }
        }
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                self.el.querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.add("zeroOpacity");
                ...
                if (window.innerWidth > 767) {
                    if (self.intervalCarousel != totalTime && self.el.classList.contains("heroCarousel")) {
                        self.intervalCarousel = totalTime;
                    }
                    var videoDivs = document.getElementsByClassName("jwplayer");
                    if (videoDivs.length != 0) {
                        for (var j = 0; j < videoDivs.length; j++) {
                            if (!videoDivs[j].parentElement.classList.contains("active")) {
                    ...
                    for (var i = 0; i < itemsActivated.length; i++) {
                        if (itemsActivated[i].classList.contains("jwplayer")) {
                            ...
                            if (!playPauseBtn.classList.contains("activePause") && jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() !== "playing") {
                                jwplayer(videoTag).play();
                            }
                            if (playPauseBtn.classList.contains("activePause") && jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() === "playing") {
                                jwplayer(videoTag).pause();
                            }
                ...
                self.el.querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.add("heritageYearHeadingAnimation");
                self.el.querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.remove("zeroOpacity");
                setTimeout(function () {
                    if (self.el.parentElement.classList.contains("heritageYearActive")) {
                        self.el.querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.remove("zeroOpacity");
                    }

                    self.el.querySelectorAll(".carItem.active")[0].getElementsByClassName("sectionContent")[0].classList.remove("heritageYearHeadingAnimation");
                }, 2000)
            }, 600);
        ...
        if (indicators.length != 0) {
            for (var i = 0; i < indicators.length; i++) {
                ...
                indicators[i].addEventListener("click", function (event) {
                    ...
                    self.startImgTimer(self);
                    var jwVideoElem = heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer");
                    if (jwVideoElem.length != 0) {
                        jwplayer(jwVideoElem[0]).stop();
                        if (!playPauseBtn.classList.contains("activePause") && jwplayer(heritageBanner[getAttr].querySelectorAll(".carItem.active > .jwplayer")[0]).getState() !== "playing") {
                            jwplayer(jwVideoElem[0]).play();
                        }
                    }
                });
...
(function () {
            ...
            if (modalDialog.length !== 0) {
                ...
                if (targetElement == flyoutElement || targetElement == flyoutElement1) {
                    ...
                    if ((targetElement === linkCopy[0].children[0] || targetElement === linkCopy[0].children[1]) && !textareaOpen) {
                        ...
                        if (copyAll.length !== 0) {
                            var urlCopiedall = copyAll[0].parentElement.nextElementSibling.children[0];
                        ...
                        if (linkCopy.length !== 0) {
                            var urlCopied = linkCopy[0].parentElement.nextElementSibling.children[0];
    ...
    function copyAllFunction() {
        ...
        var imgsrc = copyAll.getElementsByTagName("img")[0].getAttribute("src");
        var hoverimgsrc = copyAll.getElementsByTagName("img")[1].getAttribute("src");
        copyAll.getElementsByTagName("img")[0].src = hoverimgsrc;
        setTimeout(function () {
            copyAll.getElementsByTagName("img")[0].src = imgsrc;

        }, 200);
        var paraDiv = document.getElementsByClassName("copyText");
        var allText = [];
        var urlCopied = document.getElementsByClassName("urlCopied");
        var textArea = copyAll.parentElement.nextElementSibling.children[0];
        ...
        if (isSafari || iOS && window.innerWidth < 991) {
            if ((urlCopied.length !== 0) && (urlCopied[1].classList.contains('urlCopiediOs'))) {
                urlCopied[1].style.display = "none";
                urlCopied[1].classList.remove("urlCopiediOs");
            }
    ...
    function copyUrlModal() {
        ...
        var urlCopied = document.getElementsByClassName("urlCopied");
        var textArea = linkCopy.parentElement.nextElementSibling.children[0];

        if (isSafari || iOS && window.innerWidth < 991) {

            if ((urlCopied.length !== 0) && (urlCopied[0].classList.contains('urlCopiediOs'))) {
                urlCopied[0].style.display = "none";
                urlCopied[0].classList.remove("urlCopiediOs");
            }
            textArea.style.display = "block";
            textArea.classList.add("urlCopiediOs");
