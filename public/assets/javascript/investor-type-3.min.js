...
if(spinnerOverlay){
    var storySpinner = spinnerOverlay.getElementsByClassName("modalGlobalSearch")[0];    
    ...
    window.addEventListener("click",function(e){
        var temp2 = e.target.getAttribute("href");
        if (temp2 == null || !temp2.endsWith("downloading")){
            storySpinner.style.display = "none";
        }

    },false);
    for (var i=0; i<allLinks.length; i++){
        var temp = allLinks[i].getAttribute("href");
        if (temp != null && temp.endsWith("downloading")){
