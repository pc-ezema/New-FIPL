...
//this for redirecting user to homepage on click of fipl logo in footer
...
window.addEventListener("load", function (event) {
  if (document.getElementsByClassName("twitterMentions").length === 0) {
    ...
    var twitterMentionServletJobLanding = "/bin/fipl/jobPostingsCountServlet?";
  ...
  if (fb || twitter || linkedin || mailto) {
    if (fb[i]) {
      ...
      function chngImgColorfb() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/color/FB.svg)";
      }
      fb[i].addEventListener("mouseleave", chngImgfb);

      function chngImgfb() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/FB.svg)";
      }
    }
    if (twitter[i]) {
      ...
      function chngImgColortwitter() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/color/x-icon.svg)";
      }
      twitter[i].addEventListener("mouseleave", chngImgtwitter);

      function chngImgtwitter() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/x-icon.svg)";
      }
    }
    if (linkedin[i]) {
      ...
      function chngImgColorlinkedin() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/color/LinkedIn.svg)";
      }
      linkedin[i].addEventListener("mouseleave", chngImglinkedin);

      function chngImglinkedin() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/LinkedIn.svg)";
      }
    }
    if (mailto[i]) {
      ...
      function chngImgColormailto() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/color/Contact_Us.svg)";
      }
      mailto[i].addEventListener("mouseleave", chngImgmailto);

      function chngImgmailto() {
        this.style.backgroundImage = "url(/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/shareOptions/Contact_Us.svg)";
      }
    }
    if (fb[i].parentElement.getAttribute("pageshare")) {
      var currentUrl = fb[i].parentElement.getAttribute("pageshare");
      if (!currentUrl.includes("fipl.com")) {
        currentUrl = window.location.origin + currentUrl;
      }
      currentUrl = currentUrl.replace("/content/fipl/en", "");
    } else
    ...
    if (currentUrl.includes("http")) {
      ...
      mailto[i].setAttribute(
        "href",
        "mailto:?subject= fipl.com url&body=%20" + currentUrl
      );
    } else {
      fb[i].setAttribute(
        "href",
      ...
      mailto[i].setAttribute(
        "href",
        "mailto:?subject= fipl.com url&body=%20https://" + currentUrl
      );
    }
    ...
    show: function () {
      ...
      for (var i = 0; i < fb.length; i++) {
        if (fb || twitter || linkedin || mailto) {
          ...
          mailto[i].setAttribute("href", "mailto:?Subject= fipl.com url&Body=%20" + currentUrl);
          var isMobile = {
            Android: function () {
              return navigator.userAgent.match(/Android/i);
            },
...
function validateInput(isGlobal) {
    ...
    if (searchInput.value.replace(/[#|,|;]/g,"") !== "" && searchInput.value.replace(/[#|,|;]/g,"") != null && searchInput.value.replace(/[#|,|;]/g,"") !== "undefined") {
        ...
        if (isRegexValidated) {
            ...
            huge_list.innerHTML = "<div class='errorDesc'>"+"Sorry, we couldn't find a match for your search: \""+ searchInput.value +"\"</div><div class='errorDesc'>"+"Please check for spelling errors or try a broader search term."+"</div><div class='errorDesc'>"+"Alternatively, you could:"+"<br><ul><li><a class='globalSearchSuggestion'href='https://www.fipl.com/about-us'>"+"Learn more about us"+"</a></li><li>"+"Browse "+"<a class='globalSearchSuggestion' href='https://www.fipl.com/business/overview'>"+"businesses and companies"+"</a></li><li>"+"Read about "+"<a class='globalSearchSuggestion' href='https://www.fipl.com/community'>"+" our community work"+"</a></li><li><a class='globalSearchSuggestion' href='https://www.fipl.com/careers/jobs/'>"+"Find a job"+"</a></li><li>"+"Or "+"<a class='globalSearchSuggestion' href='https://www.fipl.com/newsroom/community/dogs-bombay-house'>"+"meet our friends"+"</a></li></ul></div>";
            tagsEl.innerHTML = "";
            pagination.style.display = "none";
        }
    }
...
function cardsToHtml(cardsList, cardsToShow) {
    for (var i = cardsToShow.startIndex; i <= cardsToShow.endIndex; i++) {
        ...
        if (
            ...
            img.setAttribute(
                "src",
                "" + "/content/dam/fipl/images/footer/fipl-logo-160x125.jpg"
            );
        }
        ...
        titleDiv.innerHTML =
            ...
            cardsList[i].redirectLink.replace("/content/fipl/en", "") +
        ...
        exterImg.setAttribute(
            "src",
            "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/externalLinkIcon.svg"
        );
        ...
        interImg.setAttribute(
            "src",
            "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/arrow_icon_yellow.svg"
        );
        interImg.setAttribute("class", "exterImg");
        interImg.setAttribute("alt", "Arrow");
      
        externalLink.setAttribute("target", "_blank");
        if (cardsList[i].redirectLink.includes("/content/fipl/en")) {
        ...
        copyImg.setAttribute(
            "src",
            "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/copyIcon.svg"
        );
        ...
        copyImgActive.setAttribute(
            "src",
            "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/copyIconActive.svg"
        );
        ...
        if (cardsList[i].redirectLink.includes("/content/fipl/en")) {
            textarea.innerHTML = window.location.origin + cardsList[i].redirectLink.replace("/content/fipl/en", "");
        } else {
            textarea.innerHTML = cardsList[i].redirectLink.replace("/content/fipl/en", "");
        }
        ...
        if (cardsList[i].twitterLink && cardsList[i].twitterLink.length != 0) {
            ...
            twitterImg.setAttribute(
                "src",
                "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/x-icon.svg"
            );
            ...
            twitterImgActive.setAttribute(
                "src",
                "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/x-icon-active.svg"
            );
        ...
        if (cardsList[i].phoneDetails && cardsList[i].phoneDetails.length != 0) {
            ...
            phoneImg.setAttribute(
                "src",
                "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/phoneIcon.svg"
            );
            ...
            phoneImgActive.setAttribute(
                "src",
                "/etc.clientlibs/fipl/clientlibs/assets/resources/img/common/globalSearch/phoneIconActive.svg"
            );
