...
var darkModeVolume =  document.querySelector(".darkModeVolume");
var darkModePlay =  document.querySelector(".darkModePlay");
...
var playWhite_src = play_pause_btn.getElementsByTagName('img')[4].getAttribute('src');
var pauseWhite_src = play_pause_btn.getElementsByTagName('img')[5].getAttribute('src');
...
play_pause_btn.addEventListener('click',(e)=>{
    if(music.paused || music.currentTime < 0){
        ...
        if (mouseOverPlay && window.innerWidth >= 991){
            play_button.src = pauseOrg_src;
            darkModePlay.src = pauseOrg_src;
        }else if(window.innerWidth >= 991){
            play_button.src = pause_src;
            darkModePlay.src = pauseWhite_src;
        }
    }
    else{
        music.pause();
        ...
        if (mouseOverPlay && window.innerWidth >= 991){
            play_button.src = playOrg_src;
            darkModePlay.src = playOrg_src;
        }else if(window.innerWidth >= 991){
            play_button.src = play_src;
            darkModePlay.src = playWhite_src;
        }
    }
    if(window.innerWidth < 991){
        if(music.paused || music.currentTime < 0){
            ...
            play_pause_btn.getElementsByTagName('img')[0].src  = pauseOrg_src;
            darkModePlay.src = pauseOrg_src;
            
            setTimeout(function () {
               // play_pause_btn.getElementsByTagName('img')[2].src = pause_src;
               play_pause_btn.getElementsByTagName('img')[0].src = pause_src; 
               darkModePlay.src = pauseWhite_src; 
...
var dark_img_src = playback_speed_btn.getElementsByTagName('img')[1].getAttribute('src');
var hoverImg_src = playback_speed_btn.getElementsByTagName('img')[2].getAttribute('src');
...
playback_speed_btn.addEventListener('click', ()=>{
    ...
    if(speedRate_list.classList.contains('active')){
        ...
        playback_speed_btn.getElementsByTagName('img')[1].src = hoverImg_src;

    }else{
        playback_speed_btn.getElementsByTagName('img')[0].src = orignalImg_src;
        playback_speed_btn.getElementsByTagName('img')[1].src = dark_img_src;
    }
});
...
music.addEventListener('volumechange', ()=>{
    ...
    if(music.muted || music.volume === 0){
        ...
        if(window.innerWidth >= 991){
            if (!mouseOverVolume){
                full_volume.src = muted.src;
                darkModeVolume.src = mutedImgWhite_src;
            }else{
                full_volume.src = mutedImgOrg_src;
                darkModeVolume.src = mutedImgOrg_src;
            }
        }
        ...
        if (!mouseOverVolume){
            full_volume.src = half_volume.src;
            darkModeVolume.src = halfVolImgWhite_src;
        }else{
            full_volume.src = halfVolImgOrg_src;
            darkModeVolume.src = halfVolImgOrg_src;
        }
    }
    else{
        if(window.innerWidth >= 991){
            if (!mouseOverVolume){
                full_volume.src = fullVolImg_src;
                darkModeVolume.src = fullVolImgWhite_src;
            }else{
                full_volume.src = fullVolImgOrg_src;
                darkModeVolume.src = fullVolImgOrg_src;
            }
        }
...
var fullVolImgWhite_src = volume_btn.getElementsByTagName('img')[6].getAttribute('src');
var halfVolImgWhite_src = volume_btn.getElementsByTagName('img')[7].getAttribute('src');
var mutedImgWhite_src = volume_btn.getElementsByTagName('img')[8].getAttribute('src');
...
play_pause_btn.addEventListener('mouseover',(e)=>{
        ...
        mouseOverVolume = false;
            ...
            if(music.muted || music.volume === 0){
                ...
                full_volume.src = halfVolImg_src;
                darkModeVolume.src = halfVolImgWhite_src;
            }else{
                full_volume.src = fullVolImg_src;
                darkModeVolume.src = fullVolImgWhite_src;
